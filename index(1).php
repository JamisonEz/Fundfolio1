...
<body>
    <div>
        ...
        <div id="main_content" style="position: relative; display: inline-block; overflow: hidden; width: 100%;">
            ...
            <img id="background_img" src="images/background_opt.png" style="position: absolute; pointer-events: none; z-index: -1; width: 100%;">
		                ...
		                <div class="col s4" style="margin-left: 0px; margin-top: 50px">
		                    <a href="usercampaign.php?folio_id=<?php echo $campaign['campaignid'];  ?>">
		                        <div class="card" style="">
		                            ...
		                            <div class="container1" style="background-color: rgb(249,249,249);">
		                                <h5><b><?php  echo $campaign['campaignname']; ?></b></h5>
		                                <p><?php  echo $campaign['description']; ?></p>
		                            </div>
		                            <div class="row" style="padding: 2px 16px;color: #76777B; background-color: rgb(249,249,249);">
                                		<img class="col s2" src="images/location.png" style="padding: 0; height: 25px; width: 18px;margin: 10px 0">
                                		<h5 class="col s9" style="font-size: medium;">Indianapolis, IN</h5>
                            		</div>
		                        </div>
		                    </a>
		                    <div class="progress">
        ...
        <footer class="page-footer" style="background-color: #F9F9F9">
            <div class="container">
                <div id="footer_links" class="row">
                    <div class="col s1" style="padding: 0 15px; width: auto">
                        <a href="#">About</a>
                    </div>
                    <div class="col s1" style="padding: 0 15px; width: auto">
                        <a>Jobs</a>
                    ...
                    <div class="col s5" style="float: right;">
                        <div class="col s7">
                            <input type="text" placeholder="Email Address" style="background-color: white; padding-left: 15px; border: 0;height: 40px; ">
                        </div>
                        <div class="col s5">
                            <button style="background-color: #4276E2; height: 40px; color: white; font-size: large; border-radius: 2px; padding: 7px; border: 0; width: auto">Stay Connected</button>
                        </div>
                    </div>
                </div>
